...
public class StateMachine {
  ...
  /**
   * Adds a new Transition to the StateMachine Keeps a list of all unique States added to the
   * StateMachine
   *
   ...
   * @return MachineResponse.NOPATH if no registered Transitions, MachineResponse.BLOCKED if all
   *     registered Transitions are blocked, MachineResponse.SUCCESSFUL if succeeded
   */
  ...
  /**
   * Completes a Transition by setting current state, printing, and activating the new current
   * State's action
   */
